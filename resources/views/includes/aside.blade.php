<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand">
        <a href="" class="app-brand-link"><span class="text-primary">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-header small">
            <span class="menu-header-text" data-i18n="Forms &amp; Tables">Main Menu</span>
        </li>
        <!-- Dashboard -->
        <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="{{ route('users') }}" class="menu-link">
                ...
                <div data-i18n="Tables">User Account</div>
            </a>
        </li>

        <li class="menu-header small">
            <span class="menu-header-text" data-i18n="Forms &amp; Tables">System Maintenance</span>
        </li>
        ...
        {{-- <li class="menu-item">
            <a href="" class="menu-link">
                ...
                <div data-i18n="Tables">System Access</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="" class="menu-link">
                <i class="menu-icon tf-icons bx bx-lock"></i>
                <div data-i18n="Tables">Login Logs</div>
            </a>
        </li> --}}
        ...
        {{-- <li class="menu-item">
            <a href="" class="menu-link">
                ...
                <div data-i18n="Tables">System Configuration</div>
            </a>
        </li> --}}
    </ul>
</aside>
