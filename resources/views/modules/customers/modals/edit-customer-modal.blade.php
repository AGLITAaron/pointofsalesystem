        ...
        <div class="row">
            <div class="col-12 mb-3">
                ...
                <input type="text" id="customer-name" name="customer-name" class="form-control"
                    placeholder="Enter customer name" autocomplete="off" value="{{ $customers->CustomerName }}" />
            </div>
        </div>
        <div class="row">
            <div class="col-4 mb-3">
                ...
                <select id="gender" name="gender" class="form-select">
                    ...
                    @foreach ($gender as $list)
                        <option
                            value="{{ $list->GenderID }}"{{ $list->GenderID == $customers->GenderID ? 'selected' : '' }}>
                            {{ $list->Gender }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="row">
            <div class="col-12 mb-3">
                ...
                <input type="text" id="permanent-address" name="permanent-address" class="form-control"
                    ...
                    value="{{ $customers->CompleteAddress }}" />
            </div>
        </div>
        <div class="row">
            <div class="col-4 mb-3">
                ...
                <input type="text" id="province" name="province" class="form-control" placeholder="Enter province"
                    autocomplete="off" value="{{ $customers->Province }}" />
            </div>
            <div class="col-4 mb-3">
                ...
                <input type="text" id="municipality" name="municipality" class="form-control"
                    placeholder="Enter municipality" autocomplete="off" value="{{ $customers->Municipality }}" />
            </div>
            <div class="col-4 mb-3">
                ...
                <input type="text" id="barangay" name="barangay" class="form-control" placeholder="Enter barangay"
                    autocomplete="off" value="{{ $customers->Barangay }}" />
            </div>
        </div>
    </div>
