    ...
    <div class="modal-body ">
        <div class="row">
            <div class="col-6 mb-3">
                ...
                <label for="nameSlideTop" class="form-label"><strong>Name:</strong></label>
        ...
        <div class="row">
            <div class="col-6 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="contact-number" name="contact-number" class="form-control"
                        placeholder="Enter contact number" autocomplete="off" value="{{ $employee->ContactNumber }}" />
                </div>
            </div>
            <div class="col-6 mb-3">
                ...
                <select id="gender" name="gender" class="form-select">
                    ...
                    @foreach ($gender as $list)
                        <option value="{{ $list->GenderID }}"
                            {{ $list->GenderID == $employee->GenderID ? 'selected' : '' }}>{{ $list->Gender }}</option>
                    @endforeach
                </select>
            </div>
        </div>
            ...
            <div class="col-4 mb-3">
                ...
                <select id="salary" name="salary" class="form-select">
                    ...
                    @foreach ($salary as $list)
                        <option value="{{ $list->SalaryID }}"
                            {{ $list->SalaryID == $employee->SalaryID ? 'selected' : '' }}>₱
                            {{ number_format($list->Salary, 2) }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        <div class="row">
            <div class="col-12 mb-3">
                ...
                <input type="text" id="complete-address" name="complete-address" class="form-control"
                    placeholder="Enter complete address" autocomplete="off" value="{{ $employee->CompleteAdddress }}" />
            </div>
        </div>
        <div class="row">
            <div class="col-4 mb-3">
                ...
                <input type="text" id="province" name="province" class="form-control" placeholder="Enter province"
                    autocomplete="off"value="{{ $employee->Province }}" />
            </div>
            <div class="col-4 mb-3">
                ...
                <input type="text" id="municipality" name="municipality" class="form-control"
                    placeholder="Enter municipality" autocomplete="off" value="{{ $employee->Municipality }}" />
            </div>
            <div class="col-4 mb-3">
                ...
                <input type="text" id="barangay" name="barangay" class="form-control" placeholder="Enter barangay"
                    autocomplete="off" value="$employee->Barangay }}" />
            </div>
        </div>
